...
int func_01F6DC30_amusement_02(void) {
    ...
    if (ret == 0) {
        ...
        temp_v0_2 = shCharacterGetSubCharacter(MEMORY_OF_ALESSA_CHARA_KIND, 0);
        if (temp_v0_2 != 0) {
            func_001D37E0(temp_v0_2, 3, 0, 0, 0);
        }
        temp_s1 = shCharacterGetSubCharacter(MEMORY_OF_ALESSA_CHARA_KIND, 0x18D);
        func_001E22F0(MEMORY_OF_ALESSA_CHARA_KIND, 0x18D, 0);
        func_001DC9E0(temp_s1, 0);
    } else {
        SubCharacter* temp_s1_2;
        temp_s1_2 = shCharacterGetSubCharacter(MEMORY_OF_ALESSA_CHARA_KIND, 0x18D);
        func_001E22F0(MEMORY_OF_ALESSA_CHARA_KIND, 0x18D, 1);
